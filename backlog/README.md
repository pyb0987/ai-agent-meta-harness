...
|-------|----------------|---------------|
| Distribution and install UX | How users install, activate, migrate, and eventually publish adapter bundles | `core.md` 8-9; `claude-adapter.md` 1 old install smoke; `codex-adapter.md` 4-5, 16-19, 39 |
...
| Verification and release gates | Deterministic verify commands, adapter smoke tests, release checklist, and staged/index semantics for repository checks | `core.md` 3, 9-10, 43; `claude-adapter.md` 1 fixture/temp-git follow-ups; `codex-adapter.md` 6, 11, 18-19, 38 |
...
| Documentation boundary and examples | Keeping core as what/why, adapters as runtime how, and adding realistic examples without duplicating methodology | `core.md` 7, 42, 44-45; `codex-adapter.md` 10-11; adapter README/example follow-ups |
